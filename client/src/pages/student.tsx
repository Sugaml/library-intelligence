...
import { fetchStudent, Student } from "@/lib/student";
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center space-x-4">
            <Button
              onClick={() => window.location.href = '/issue-book/' + student?.id}
  ...
  <CardContent className="py-6 text-gray-800 bg-white">
    {isLoading ? (
      <div className="space-y-3">
        {[...Array(6)].map((_, i) => (
          <Skeleton key={i} className="h-4 w-2/3 rounded-md" />
        ))}
      </div>
    ) : isError || !student ? (
      <p className="text-red-600 font-semibold">Failed to load student details.</p>
    ) : (
      <dl className="grid grid-cols-2 gap-x-8 gap-y-6">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <dd className="mt-1 text-sm text-gray-600">{student.name}</dd>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <dt className="text-sm font-semibold text-gray-900">Username</dt>
            <dd className="mt-1 text-sm text-gray-600">{student.username}</dd>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <dd className="mt-1 text-sm text-gray-600">{student.email}</dd>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-3">
          <IdentificationIcon className="h-6 w-6 text-indigo-600" />
          <div>
            <dt className="text-sm font-semibold text-gray-900">Student ID</dt>
            <dd className="mt-1 text-sm text-gray-600">{student.student_id}</dd>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <dd className="mt-1 text-sm text-gray-600">{student.program}</dd>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-3">
          <UserIcon className="h-6 w-6 text-indigo-600" />
          <div>
            <dt className="text-sm font-semibold text-gray-900">Role</dt>
            <dd className="mt-1 text-sm text-gray-600">{student.role}</dd>
          </div>
        </div>
      </dl>
    )}
        ...
        <Tabs defaultValue="all-issues" className="space-y-6">
          ...
          <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Book Issue Information</h1>
          <p className="text-gray-600 mt-1">Manage book borrowing activities</p>
        </div>
          {/* Search and Filters */}
